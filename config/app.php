...
return [
   ...
   */
  'debug' => filter_var(env('DEBUG', !__PROD__), FILTER_VALIDATE_BOOLEAN),
  ...
  'Garmin' => [
    'apiKey' => $APP['GARMIN']['API_KEY'],
  ],

  'Google' => [
    'analyticsCode' => $APP['GOOGLE']['ANALYTICS_CODE'],
    'apiKey' => $APP['GOOGLE']['API_KEY'],
    'timezoneApiKey' => $APP['GOOGLE']['TIMEZONE_API_KEY'],
  ],
   ...
   */
  'Security' => [
    'salt' => env('SECURITY_SALT', $APP['SALT']),
  ],
