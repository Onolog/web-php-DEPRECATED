 ...
 * @requires Garmin.PluginDetect
 * @requires Garmin.MessageBox
 * @requires Garmin.TransferProgress 
 */
define([

  'lib/garmin/device/GarminDevicePlugin',
  'lib/garmin/device/GarminMessageBox',
  'lib/garmin/device/GarminTransferProgress',
   ...
   */
	readDataFromDevice: function(fileType, fileListingOptions) {
      ...
      switch (this.gpsDataType) {        		
		...
		} catch(e) { this._reportException(e); }
	},
	...
	readDetailFromDevice: function(fileType, dataId) {
		...
		try {
      this._broadcaster.dispatch('onStartReadFromDevice', {
        controller: this
      });
