...
const Typeahead = React.createClass({
  ...
  getInitialState: function() {
    ...
    return {
      ...
      selected: multiple ? selected : head(selected),
      showMenu: false,
      text: (!multiple && head(selected) && head(selected)[labelKey]) || ''
    };
  },

  componentWillReceiveProps: function(nextProps) {
    if (!isEqual(nextProps.selected, this.state.selected)) {
  ...
  render: function() {
    ...
    var InputComponent = multiple ? TokenizerInput : TypeaheadInput;
