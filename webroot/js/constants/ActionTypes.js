...
module.exports = {
  ...
  ACTIVITY_DELETE_ERROR: 'activity-delete-error',
  ACTIVITY_DELETE_SUCCESS: 'activity-delete-success',
  ACTIVITY_UPDATE: 'activity-update',
  ACTIVITY_UPDATE_ERROR: 'activity-update-error',
  ACTIVITY_UPDATE_SUCCESS: 'activity-update-success',
  ACTIVITY_VIEW: 'activity-view',
  ACTIVITY_VIEW_ERROR: 'activity-view-error',
  ACTIVITY_VIEW_SUCCESS: 'activity-view-success',
  ...
  SHOE_VIEW_SUCCESS: 'shoe-view-success',
